...
*/ var r =
  ...
  function(e, t, n) {
    ...
    var Ul = {
      ...
      enqueueForceUpdate: function(e, t) {
        ...
        var n = _i(),
          r = rl((n = Xo(n, e)))
        ;(r.tag = 2), null != t && (r.callback = t), Ho(), ol(e, r), Jo(e, n)
      },
    }
    ...
    function po(e, t, n) {
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        ...
        case 14:
          return ro(e, t, (l = t.type), (o = Ol(l.type, t.pendingProps)), r, n)
        case 15:
    ...
    function wo(e) {
      switch (('function' == typeof Ar && Ar(e), e.tag)) {
        ...
        case 1:
          if (
            (ko(e), 'function' == typeof (t = e.stateNode).componentWillUnmount)
          )
            try {
    ...
    function _o(e) {
      for (var t = e, n = !1, r = void 0, l = void 0; ; ) {
        ...
        if (5 === t.tag || 6 === t.tag) {
          ...
          (4 === t.tag ? ((r = t.stateNode.containerInfo), (l = !0)) : wo(t),
          null !== t.child)
        ) {
    ...
    var No = { readContext: kl },
      Oo = $e.ReactCurrentOwner,
      Mo = 1073741822,
      Io = 0,
      Do = !1,
      Uo = null,
    ...
    function $o() {
      ...
      ;(Fo = null), (Ro = 0), (zo = -1), (Lo = !1), (Uo = null)
    }
    function Ho() {
      null !== Vo && (o.unstable_cancelCallback(Wo), Vo())
    }
    function Qo(e) {
      for (;;) {
        var t = e.alternate,
        ...
        if (0 == (1024 & e.effectTag)) {
          ...
          if (null !== (e = Po(e))) return (e.effectTag &= 1023), e
          null !== n &&
    ...
    function qo(e, t) {
      Do && i('243'), Ho(), (Do = !0), (Oo.currentDispatcher = No)
      var n = e.nextExpirationTimeToWorkOn
      ;(n === Ro && e === Fo && null !== Uo) ||
        ($o(),
        (Ro = n),
        (Uo = $r((Fo = e).current, null)),
        (e.pendingCommitExpirationTime = 0))
      for (var r = !1; ; ) {
        try {
          if (t) for (; null !== Uo && !Pi(); ) Uo = Ko(Uo)
          else for (; null !== Uo; ) Uo = Ko(Uo)
        } catch (t) {
          if (((yl = hl = ml = null), null === Uo)) (r = !0), Ui(t)
          else {
            null === Uo && i('271')
            var l = Uo,
              o = l.return
                ...
                if (
                  ...
                  do {
                    if (
                      ...
                      ;-1 === d
                        ? (a = 1073741823)
                        : (-1 === p && (p = 10 * (1073741822 - Zr(a, o)) - 5e3),
                          (a = p + d)),
                        0 <= a && zo < a && (zo = a),
                        (s.effectTag |= 2048),
                        (s.expirationTime = o)
      ...
      if (((Do = !1), (yl = hl = ml = Oo.currentDispatcher = null), r))
        (Fo = null), (e.finishedWork = null)
      else if (null !== Uo) e.finishedWork = null
      else {
        if ((null === (r = e.current.alternate) && i('281'), (Fo = null), Lo)) {
          if (
            ...
            return Gr(e, n), void Ti(e, r, n, e.expirationTime, -1)
          if (!e.didError && t)
            return (
              (e.didError = !0),
        ...
        t && -1 !== zo
          ? (Gr(e, n),
            (t = 10 * (1073741822 - Zr(e, n))) < zo && (zo = t),
            (t = 10 * (1073741822 - _i())),
            (t = zo - t),
            Ti(e, r, n, e.expirationTime, 0 > t ? 0 : t))
    ...
    function Yo(e, t) {
      for (var n = e.return; null !== n; ) {
        switch (n.tag) {
          ...
          case 3:
            return (
              ol(n, (e = Eo(n, (e = dl(t, e)), 1073741823))),
              void Jo(n, 1073741823)
            )
        }
        n = n.return
      ...
      3 === e.tag &&
        (ol(e, (n = Eo(e, (n = dl(t, e)), 1073741823))), Jo(e, 1073741823))
    }
    function Xo(e, t) {
      return (
        0 !== Io
    ...
    function Go(e, t, n, r) {
      ...
      if (0 !== l && r <= l && r >= o) {
        ...
        ;(0 === i || i > o) && (e.latestPingedTime = o), Jr(o, e)
      } else Xr(e, (l = Xo((l = _i()), t)))
      0 != (1 & t.mode) && e === Fo && Ro === r && (Fo = null),
        Zo(t, l),
        0 == (1 & t.mode) &&
          (Zo(n, l),
          1 === n.tag &&
    ...
    function Jo(e, t) {
      null !== (e = Zo(e, t)) &&
        (!Do && 0 !== Ro && t > Ro && $o(),
        Xr(e, t),
        (Do && !jo && Fo === e) || Ci(e, e.expirationTime),
        bi > gi && ((bi = 0), i('185')))
    }
    ...
    var ti = null,
      ...
      mi = null,
      hi = o.unstable_now(),
      yi = 1073741822 - ((hi / 10) | 0),
      vi = yi,
      gi = 50,
      bi = 0,
      ki = null
    function wi() {
      yi = 1073741822 - (((o.unstable_now() - hi) / 10) | 0)
    }
    function xi(e, t) {
      if (0 !== ri) {
        if (t < ri) return
        null !== li && o.unstable_cancelCallback(li)
      }
      ;(ri = t),
        (e = o.unstable_now() - hi),
        (li = o.unstable_scheduleCallback(Ni, {
    ...
    function _i() {
      return oi ? vi : (Ei(), (0 !== ai && 1 !== ai) || (wi(), (vi = yi)), vi)
    }
    function Ci(e, t) {
      null === e.nextScheduledRoot
        ...
        oi ||
          (fi
            ? di && ((ii = e), (ai = 1073741823), Ii(e, 1073741823, !1))
            : 1073741823 === t
            ? Oi(1073741823, !1)
            : xi(e, t))
    }
      ...
      if (null !== ni)
        for (var n = ni, r = ti; null !== r; ) {
          ...
          if (0 === l) {
            ...
            if (r === ti)
              (ti = l = r.nextScheduledRoot),
                (ni.nextScheduledRoot = l),
      ...
      try {
        if (!Pi() && null !== ti) {
          ...
          do {
            ...
            0 !== t && yi <= t && (e.nextExpirationTimeToWorkOn = yi),
    ...
    function Oi(e, t) {
      if ((Ei(), t))
        for (
          wi(), vi = yi;
          null !== ii && 0 !== ai && e <= ai && !(Si && yi > ai);

        )
          Ii(ii, ai, yi > ai), Ei(), wi(), (vi = yi)
      else for (; null !== ii && 0 !== ai && e <= ai; ) Ii(ii, ai, !1), Ei()
      if (
        (t && ((ri = 0), (li = null)),
        0 !== ai && xi(ii, ai),
        (bi = 0),
    ...
    function Mi(e, t) {
      oi && i('253'), (ii = e), (ai = t), Ii(e, t, !1), Oi(1073741823, !1)
    }
    function Ii(e, t, n) {
      if ((oi && i('245'), (oi = !0), n)) {
    ...
    function Di(e, t, n) {
      ...
      for (
        hr = { focusedElem: l, selectionRange: o }, _n = !1, Ao = r;
        null !== Ao;
      ...
      for (Ao = r; null !== Ao; ) {
        ...
        try {
          for (; null !== Ao; ) {
            ...
            switch (14 & T) {
              case 2:
                To(Ao), (Ao.effectTag &= -3)
                break
              case 6:
                To(Ao), (Ao.effectTag &= -3), Co(Ao.alternate, Ao)
                break
              case 4:
                Co(Ao.alternate, Ao)
                break
      ...
      for (
        hr = null, _n = !!mr, mr = null, e.current = t, Ao = r;
        null !== Ao;
      ...
      ;(Do = jo = !1),
        ...
        (E = t.expirationTime),
        0 === (t = (t = t.childExpirationTime) > E ? t : E) && (Bo = null),
        (e.expirationTime = t),
        (e.finishedWork = null)
    }
    function Ui(e) {
    ...
    function Wi(e) {
      var t = 1073741822 - 25 * (1 + (((1073741822 - _i() + 500) / 25) | 0))
      t >= Mo && (t = Mo - 1),
  ...
  function(e, t, n) {
    ...
    var i = class extends r.Component {
      render() {
        return l.a.createElement('h1', null, 'ASAS')
      }
    }
    n.n(o).a.render(
      l.a.createElement(
        class extends r.Component {
          render() {
            return l.a.createElement('div', null, l.a.createElement(i, null))
          }
        },
        null,
      ),
